...
const PopUp = ({ onClose , popUpType = "1"}) => {
   ...
   return (
      <div onClick={closeModel} ref={modelRef} className="z-100 fixed inset-0 bg-opacity-30 backdrop-blur-sm flex justify-center pt-10 overflow-scroll scrollbar-hide">
         {loading ? <Loading></Loading> : (
            ...
            <div className="flex flex-col text-white">
               ...
               <div className="rounded-xl flex flex-col items-center mx-4 bg-white border-1 border-black border-dashed">
